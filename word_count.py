...
opportunity = ['advancement', 'advantage', 'befalling', 'break', 'chance', 'connection', 'contingency', 'convenience',
               ...
               'opportunity', 'optimism', 'optimist', 'optimistic', 'outlook', 'possibility', 'prospect', 'prospects',
               'prosperity', 'prosperous', 'recourse', 'stimulating', 'successful', 'suitable', 'time', 'turn',
               'upbeat', 'viable']
#                                  1                       1                                                             2/7      2/3                                                                                                                                                     0/1                                                                 1                                                             3 1\n           3                                                                                                                                                                                   3/6 2.   0/4
# JPM2001 = 16
threat = ['alarming', 'alarming fateful', 'apocalyptic', 'assault', 'baleful', 'baneful', 'black', 'cautionary',
          'challenging', 'comminatory', 'conflict', 'constrained', 'crisis', 'crunch', 'danger', 'dangerous', 'demur',
...
enactment = ['absorb', 'access', 'accomplish', 'accrue', 'achieve', 'acquire', 'acquisition', 'act', 'action', 'active',
             ...
             'boost', 'campaign', 'cement', 'censure', 'centralize', 'change', 'charge', 'cite', 'coalesce', 'combat',
             ...
             'distention', 'divest', 'divestiture', 'effect', 'enact', 'encounter', 'engage', 'engagement', 'enlarge',
             'enterprise', 'environment', 'environs', 'execute', 'exercise', 'exert', 'expand', 'expands', 'expansion',
             ...
             'manipulate', 'market', 'marry', 'meld', 'merge', 'mingle', 'modify', 'move', 'network', 'niche', 'nook',
             'occupy', 'operate', 'operation', 'oust', 'perform', 'persuade', 'pitch', 'planted', 'plug', 'politick',
             ...
             'secure', 'sell', 'separate', 'solicit', 'stir', 'strive', 'struggle', 'sway', 'syndicate', 'synthesize',
             'team', 'team up', 'terrain', 'territory', 'thrust', 'transact', 'turgescence', 'undertake', 'unite',
             'urge', 'vie', 'win']
#                                                            2                      0/4s       3/15     0/5                                                                                                                                 0/1                                                                                                                 0/1s                                                                                                                         1/2       0/1      1/2                             0/4                                 1/2
# JPM2001 = 8...

org_iden = ['abreast', 'accede', 'acceded', 'accedes', 'acceding', 'accept', 'accepted', 'accepting', 'accepts',
            'accommodate', 'accommodated', 'accommodates', 'accommodation', 'accompanied', 'accompanies', 'accompany',
            ...
            'align', 'aligned', 'aligning', 'alignment', 'alignments', 'aligns', 'alike', 'all', 'alliances', 'allied',
            ...
            'approving', 'arbitrate', 'arbitrated', 'arbitrating', 'arbitration', 'arbitrations', 'arrange', 'arranged',
            ...
            'associate', 'associated', 'associates', 'associating', 'association', 'associations', 'atmosphere', 'aura',
            'authentic', 'balance', 'balance-of-power', 'balanced', 'balances', 'balancing', 'bandwagon', 'bandwagons',
            ...
            'bonds', 'bound', 'brotherhood', 'brotherhoods', 'buddies', 'buddy', 'cahoots', 'camaraderie', 'cardinal',
            ...
            'class-action', 'class-based', 'classes', 'classification', 'classifications', 'classified', 'classifies',
            'classify', 'classifying', 'classmate', 'classmates', 'climate', 'clique', 'cliques', 'close', 'closeness',
            'closer', 'closest', 'club', 'clubs', 'cluster', 'clustered', 'clustering', 'clusters', 'co-worker',
            'coalition', 'coalitions', 'cohere', 'coherent', 'cohesive', 'cohort', 'cohorts', 'coincide', 'coincided',
            'coincides', 'coinciding', 'collaborate', 'collaborated', 'collaborates', 'collaboration', 'collaborations',
            'colleague', 'colleagues', 'collection', 'collections', 'collective', 'collectives', 'collude', 'colluded',
            'colludes', 'colluding', 'collusion', 'collusions', 'combination', 'combinations', 'combine', 'combined',
            'combines', 'combining', 'commend', 'commended', 'commending', 'commends', 'commission', 'commissions',
            'committee', 'committees', 'communal', 'commune', 'communes', 'communities', 'companion', 'companionable',
            'companions', 'companionship', 'comparable', 'comparably', 'compatibilities', 'compatibility', 'compatible',
            ...
            'confirm', 'confirmation', 'confirmations', 'confirmed', 'confirming', 'confirms', 'conform', 'conformed',
            ...
            'connecting', 'connection', 'connections', 'connects', 'consensus', 'consent', 'consented', 'consenting',
            'consents', 'consistencies', 'consistency', 'consistent', 'consolidate', 'consolidated', 'consolidates',
            'consolidating', 'consolidation', 'consolidations', 'consonance', 'conspiracies', 'conspiracy', 'conspire',
            'conspired', 'conspires', 'constant', 'contact', 'contacted', 'contacting', 'context', 'continual',
            'continuous', 'contracted', 'contracting', 'contributed', 'contributes', 'contribution', 'contributions',
            ...
            'corresponding', 'covenant', 'covenants', 'cronies', 'crony', 'culture', 'customary', 'customs', 'dealings',
            ...
            'duplicates', 'duplicating', 'd\xe9tente', 'echo', 'echoed', 'echoes', 'echoing', 'elemental', 'embrace',
            'embraced', 'embraces', 'embracing', 'empathize', 'empathized', 'empathizes', 'empathizing', 'empathy',
            'endorse', 'endorsed', 'endorses', 'endorsing', 'enduring', 'environ', 'equal', 'equalities', 'equality',
            ...
            'hospitable', 'hospitality', 'identical', 'illustrative', 'immutable', 'important', 'incessant', 'include',
            ...
            'intermesh', 'intermeshed', 'intermeshes', 'intermeshing', 'interrelate', 'interrelated', 'interrelating',
            'interrelations', 'intersect', 'intersected', 'intersecting', 'intersection', 'intersections', 'intertwine',
            ...
            'mediating', 'medium', 'meetings', 'milieu', 'mingle', 'mingled', 'mingling', 'mood', 'mutual', 'mutuality',
            'negotiable', 'negotiate', 'negotiated', 'negotiating', 'negotiation', 'negotiations', 'networked',
            'networking', 'networks', 'noticeable', 'offer', 'offered', 'offering', 'offers', 'oneness', 'organization',
            'organizational', 'orientation', 'our', 'ourself', 'ourselves', 'palatable', 'parallel', 'parallels',
            'paramount', 'parity', 'partake', 'partakes', 'partaking', 'participate', 'participated', 'participates',
            'participation', 'particular', 'parties', 'partner', 'partners', 'partnership', 'partnerships', 'partook',
            ...
            'related', 'relates', 'relating', 'relations', 'relationship', 'relationships', 'rendezvous', 'reproduce',
            ...
            'sociability', 'sociable', 'socialization', 'socialize', 'socialized', 'socializing', 'special', 'specific',
            ...
            'sympathizes', 'sympathizing', 'sympathy', 'synchronize', 'synchronized', 'synchronizes', 'synchronizing',
            'synchronous', 'syndicate', 'syndicates', 'synonymous', 'syntheses', 'synthesis', 'synthetic', 'tantamount',
            'teamed', 'teaming', 'teammate', 'teammates', 'teams', 'teamwork', 'temperament', 'tenor', 'terrain',
            'territory', 'their', 'them', 'they', 'tie-in', 'tie-ins', 'timbre', 'together', 'tolerance', 'tolerant',
            ...
            'unifying', 'uninterrupted', 'unions', 'unique', 'unison', 'unit', 'unite', 'unites', 'uniting', 'units',
            'unity', 'unmistakable', 'unrelenting', 'unremitting', 'unties', 'unvarying', 'unwavered', 'unwavering',
            'us', 'vital', 'vouch', 'vouched', 'vouches', 'vouching', 'warrant', 'warranted', 'warranting', 'warrants',
...
def get_jpm():
    ...
    for i in range(2000, 2009 + 1):
        ...
        if text:
            ...
            print '{:>8} {:>8} {:>8} {:>8} {:>10}'.format(str(i), str(counts[0]), str(counts[1]), str(counts[2]),
                                                          str(counts[3]))


def get_jpm_small():
    table = []
    table.append(["year", "threat", "enactment", "opportunity", "org identity"])
    text = read_txt("TestSuite/JPMorgan2000_3paragraphs.txt")
    if text:
        text = utf8_to_ascii(text)
        counts = find_words(text.decode('unicode_escape').encode('ascii', 'ignore'))
        table.append(["2000", counts[0], counts[1], counts[2], counts[3]])
    return table
